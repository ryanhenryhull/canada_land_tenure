...
export default function App() {
  ...
  const stacUrl = "https://pub-5ac3c27e0001486290fb4f649e61b4a8.r2.dev/STAC/stac/catalog.json";
  ...
  // Load the fixed STAC catalog on mount
  useEffect(() => {
  ...
  return (
    <div className="w-screen h-screen relative overflow-hidden font-sans bg-slate-950 text-white">
      ...
      {/* 2. Loading indicator + error display, top-center */}
      <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-md px-4 pointer-events-none">
        <div className="space-y-2 pointer-events-auto">
          {isLoading && (
            <div className="flex items-center justify-center gap-2 bg-slate-900/90 backdrop-blur-md border border-slate-800 rounded-xl py-2 px-3 text-xs text-slate-300 shadow-2xl">
